...
local terminal_source = table.concat(vim.fn.readfile(repo_root .. "/nvim/lua/plugins/toggleterm.lua"), "\n")
...
assert(terminal_source:find('"<leader>tf"', 1, true), "ToggleTerm requires an explicit key load handler")
